...
Cohesion: 0.22
Nodes (6): Deployment, graphify, Laravel Pint Code Formatter, PHP, PHPUnit, Running Tests
...
### Community 12 - "Module"
Cohesion: 0.07
Nodes (22): create(), deleteIfUnreferenced(), findByCode(), transaction(), update(), DuplicateModuleCodeException, self, ModuleConcurrencyException (+14 more)
...
Cohesion: 0.07
Nodes (20): self, ListModulesRequest, can(), GatewayUserConnector, UserSurface, UserSurface, UserContext, BackedEnum (+12 more)
...
### Community 37 - "rules/README.md"
Cohesion: 0.29
Nodes (4): Reglas del proyecto, Confirmado, No decidido todavía, Stack tecnológico
...
Cohesion: 0.06
Nodes (19): ModuleCapabilityData, ModuleCapabilityDefinitionData, ModuleData, ModuleDefinitionData, ModuleListQueryData, ModulesPageData, paginate(), ModuleRepositoryFactory (+11 more)
...
### Community 53 - "Laravel Boost"
Cohesion: 0.50
Nodes (4): Artisan, Laravel Boost, Project Rules, Tinker

### Community 54 - "Illuminate\Support\ServiceProvider"
Cohesion: 0.24
Nodes (4): AppServiceProvider, ModulesServiceProvider, UserServiceProvider, Illuminate\Support\ServiceProvider
...
### Community 57 - "Business Domain Specifications"
Cohesion: 0.67
Nodes (3): Business Domain Specifications, Convenciones, Especificaciones

## Knowledge Gaps
- **246 isolated node(s):** `Controller`, `$schema`, `name`, `type`, `description` (+241 more)
...
- **Why does `TestCase` connect `TestCase` to `ModuleRepositoryContract`, `UserContext`, `Module`?**
