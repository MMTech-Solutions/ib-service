...
Estado: **Implementación en curso; sesión 2 completada**
...
| 5. Implementación y contract tests | [`05-s1-implementation.md`](05-s1-implementation.md) | En curso; sesión 2 completada |
...
- HTTP, permisos, Postman y concurrencia restante de Subscriptions (sesiones
  3–5).
...
Continuar S1 con la sesión 3 de
[`05-s1-implementation.md`](05-s1-implementation.md) (solicitud, consultas y
moderación), sin habilitar la capacidad hasta cerrar la sesión 5.
