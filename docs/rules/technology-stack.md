...
| `mmt/laravel-feature-scaffold` | 1.2.0 | Scaffold feature-first, excepción base `MmtException` y dependencia transitiva de `mmt/api-response-normalizer` para el envelope HTTP. |
