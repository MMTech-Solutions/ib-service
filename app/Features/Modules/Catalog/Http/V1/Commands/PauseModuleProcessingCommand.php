...
final class PauseModuleProcessingCommand extends Data
{
    ...
    public static function fromRequest(PauseModuleProcessingRequest $request, UserContext $userContext): self
    {
