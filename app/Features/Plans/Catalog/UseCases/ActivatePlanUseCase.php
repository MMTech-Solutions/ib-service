...
final class ActivatePlanUseCase
{
    ...
    public function execute(ActivatePlanCommand $command): PlanDetailData
    {
        ...
        return $repository->transaction(function () use ($repository, $command): PlanDetailData {
            ...
            $modules = array_values($this->presentPlan->index($plan->moduleIds()));
            if (! $plan->activate($modules, $now)) {
