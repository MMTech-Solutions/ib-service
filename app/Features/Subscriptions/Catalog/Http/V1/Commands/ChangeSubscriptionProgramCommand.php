...
final class ChangeSubscriptionProgramCommand extends Data
{
    ...
    public static function fromRequest(ChangeSubscriptionProgramRequest $request, UserContext $userContext): self
    {
