...
final class FixSubscriptionPlacementCommand extends Data
{
    ...
    public static function fromRequest(FixSubscriptionPlacementRequest $request, UserContext $userContext): self
    {
