...
final class ReleaseSubscriptionPlacementUseCase
{
    ...
    public function execute(ReleaseSubscriptionPlacementCommand $command): SubscriptionDetailData
    {
